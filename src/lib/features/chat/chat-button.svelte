<script lang="ts">
	...
	import { RiMoreLine as Ellipsis, RiPencilLine as PencilIcon, RiPushpin2Line as PinIcon, RiPushpin2Fill as PinOffIcon, RiGitBranchLine as SplitIcon, RiDeleteBinLine as TrashIcon } from 'remixicon-svelte';
