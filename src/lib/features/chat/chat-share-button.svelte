<script lang="ts">
	...
	import LockIcon from 'remixicon-svelte/icons/lock-line';
	import GlobeIcon from 'remixicon-svelte/icons/global-line';
	import ShareIcon from 'remixicon-svelte/icons/share-line';
